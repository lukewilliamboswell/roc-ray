...
This command must use the compiler pinned in `platform/main.roc` on `PATH`.
It leaves the checked-in example unchanged: the copied app resolves the fresh
content-addressed platform bundle over localhost.
