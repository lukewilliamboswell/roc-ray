...
import ray.Raylib exposing [PlatformState, Color, Camera]
import rand.Random
...
render = \model, { keyboardButtons, nanosTimestampUtc } ->
    ...
    Raylib.drawMode2D! model.camera (Task.forEach lines Raylib.drawRectangle)
