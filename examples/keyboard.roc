...
render! = |model, host| {
	...
	a_down = Keys.key_down(host, KeyA)
	s_down = Keys.key_down(host, KeyS)
	d_down = Keys.key_down(host, KeyD)
	up_down = Keys.key_down(host, KeyUp)
	left_down = Keys.key_down(host, KeyLeft)
	down_down = Keys.key_down(host, KeyDown)
	right_down = Keys.key_down(host, KeyRight)
	one_down = Keys.key_down(host, Key1)
	shift_down = Keys.key_down(host, KeyLeftShift) or Keys.key_down(host, KeyRightShift)
	ctrl_down = Keys.key_down(host, KeyLeftControl) or Keys.key_down(host, KeyRightControl)
	escape_pressed = Keys.key_pressed(host, KeyEscape)
	space_released = Keys.key_released(host, KeySpace)
