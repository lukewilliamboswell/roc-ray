...
import ray.Core exposing [Rectangle]
import ray.Shape2D
...
init =
    ...
    _ = Core.setWindowTitle! "Squares Demo"
...
render = \model ->
    ...
    _ = Core.drawText! { text: "Click on the screen to draw a square", posX: width - 400, posY: height - 25, fontSize: 20, color: white }

    # { x, y } = Core.getMousePosition!
