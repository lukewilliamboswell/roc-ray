...
Trace := [].{
	...
	mark! : Str => {}
	mark! = |label| TraceHost.mark!(label)
	...
	sample_f64! = |label, value, unit| TraceHost.sample_f64!(label, value, trace_unit_code(unit))
}
