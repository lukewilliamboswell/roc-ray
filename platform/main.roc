...
platform ""
	...
	exposes [App, Devices, Files, Draw, Text, Color, Window, Keys, Mouse, Gamepad, Time, Audio, Assets, Math, Camera, Sprite, Tilemap, Physics, Capture, Random, Task, Http, Udp, Url, Stdout, Stderr, Sqlite, Cmd, Trace, HostABI]
	packages {
		rrt: "../types/main.roc",
	...
	hosted {
		...
		"roc_texture_generate_checked_raw": HostABI.texture_generate_checked!,
		"roc_texture_update_raw": HostABI.texture_update!,
		"roc_texture_update_region_raw": HostABI.texture_update_region!,
		"roc_texture_set_filter_raw": HostABI.texture_set_filter!,
		"roc_texture_set_wrap_raw": HostABI.texture_set_wrap!,
		...
		"roc_text_default_font_raw": HostABI.text_default_font!,
		"roc_text_startup_default_font_raw": HostABI.text_startup_default_font!,
		"roc_text_font_metrics_raw": HostABI.text_font_metrics!,
		"roc_draw_frame_size": HostABI.draw_frame_size!,
		"roc_draw_line_raw": HostABI.draw_line!,
		"roc_text_load_font_bytes_raw": HostABI.text_load_font_bytes!,
		"roc_text_load_store_font_raw": HostABI.text_load_store_font!,
		"roc_text_prepare_raw": HostABI.text_prepare!,
		...
		"roc_texture_load_render_target_raw": HostABI.texture_load_render_target!,
		"roc_shader_load_source_raw": HostABI.shader_load_source!,
		"roc_shader_load_store_raw": HostABI.shader_load_store!,
		"roc_shader_location_raw": HostABI.shader_location!,
		"roc_shader_set_float_raw": HostABI.shader_set_float!,
		"roc_shader_set_int_raw": HostABI.shader_set_int!,
		"roc_shader_set_texture_raw": HostABI.shader_set_texture!,
		"roc_shader_set_vec2_raw": HostABI.shader_set_vec2!,
		"roc_shader_set_vec3_raw": HostABI.shader_set_vec3!,
		"roc_shader_set_vec4_raw": HostABI.shader_set_vec4!,
