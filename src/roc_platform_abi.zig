...
/// Element type for __AnonStruct_e03fc5095bd9951a
pub const __AnonStruct_e03fc5095bd9951a = if (@sizeOf(usize) == 4) extern struct {
    handle: u64,
    offset: u64,
    /// Recursively decrement Roc-owned fields.
    pub fn decref(self: @This(), roc_host: *RocHost) void {
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_e03fc5095bd9951a) != 16) @compileError("__AnonStruct_e03fc5095bd9951a size mismatch");
        if (@alignOf(__AnonStruct_e03fc5095bd9951a) != 8) @compileError("__AnonStruct_e03fc5095bd9951a alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_e03fc5095bd9951a) != 16) @compileError("__AnonStruct_e03fc5095bd9951a size mismatch");
        if (@alignOf(__AnonStruct_e03fc5095bd9951a) != 8) @compileError("__AnonStruct_e03fc5095bd9951a alignment mismatch");
...
/// Element type for __AnonStruct_6b33d8d5fd6ed20e
pub const __AnonStruct_6b33d8d5fd6ed20e = if (@sizeOf(usize) == 4) extern struct {
    capture: __AnonStruct_725e46d8f9e562ab,
    time: __AnonStruct_a7fabf5808088b4c,
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_6b33d8d5fd6ed20e) != 264) @compileError("__AnonStruct_6b33d8d5fd6ed20e size mismatch");
        if (@alignOf(__AnonStruct_6b33d8d5fd6ed20e) != 8) @compileError("__AnonStruct_6b33d8d5fd6ed20e alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_6b33d8d5fd6ed20e) != 176) @compileError("__AnonStruct_6b33d8d5fd6ed20e size mismatch");
        if (@alignOf(__AnonStruct_6b33d8d5fd6ed20e) != 8) @compileError("__AnonStruct_6b33d8d5fd6ed20e alignment mismatch");
    }
}

/// Element type for __AnonStruct_f00636e965e48f7d
pub const __AnonStruct_f00636e965e48f7d = if (@sizeOf(usize) == 4) extern struct {
    blob: u64,
    blob_len: u64,
    id: u64,
    contents: RocStr,
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_f00636e965e48f7d) != 56) @compileError("__AnonStruct_f00636e965e48f7d size mismatch");
        if (@alignOf(__AnonStruct_f00636e965e48f7d) != 8) @compileError("__AnonStruct_f00636e965e48f7d alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_f00636e965e48f7d) != 40) @compileError("__AnonStruct_f00636e965e48f7d size mismatch");
        if (@alignOf(__AnonStruct_f00636e965e48f7d) != 8) @compileError("__AnonStruct_f00636e965e48f7d alignment mismatch");
    }
}
...
/// Element type for __AnonStruct_a7fabf5808088b4c
pub const __AnonStruct_a7fabf5808088b4c = if (@sizeOf(usize) == 4) extern struct {
    frame_count: u64,
    timestamp_nanos: u64,
    elapsed_seconds: f32,
    /// Recursively decrement Roc-owned fields.
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_a7fabf5808088b4c) != 24) @compileError("__AnonStruct_a7fabf5808088b4c size mismatch");
        if (@alignOf(__AnonStruct_a7fabf5808088b4c) != 8) @compileError("__AnonStruct_a7fabf5808088b4c alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_a7fabf5808088b4c) != 24) @compileError("__AnonStruct_a7fabf5808088b4c size mismatch");
        if (@alignOf(__AnonStruct_a7fabf5808088b4c) != 8) @compileError("__AnonStruct_a7fabf5808088b4c alignment mismatch");
...
/// Element type for __AnonStruct_cc47749ab4ee4e9a
pub const __AnonStruct_cc47749ab4ee4e9a = if (@sizeOf(usize) == 4) extern struct {
    model: RocBox,
    tasks: RocList(__AnonStruct_86310e04a9e6e25c),
    /// Recursively decrement Roc-owned fields.
    pub fn decref(self: @This(), roc_host: *RocHost) void {
        const value = self;
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_cc47749ab4ee4e9a) != 32) @compileError("__AnonStruct_cc47749ab4ee4e9a size mismatch");
        if (@alignOf(__AnonStruct_cc47749ab4ee4e9a) != 8) @compileError("__AnonStruct_cc47749ab4ee4e9a alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_cc47749ab4ee4e9a) != 16) @compileError("__AnonStruct_cc47749ab4ee4e9a size mismatch");
        if (@alignOf(__AnonStruct_cc47749ab4ee4e9a) != 4) @compileError("__AnonStruct_cc47749ab4ee4e9a alignment mismatch");
    }
}

/// Element type for __AnonStruct_86310e04a9e6e25c
pub const __AnonStruct_86310e04a9e6e25c = if (@sizeOf(usize) == 4) extern struct {
    id: u64,
    millis: u64,
    path: RocStr,
    kind: u8,
...
comptime {
    if (@sizeOf(usize) == 8) {
        if (@sizeOf(__AnonStruct_86310e04a9e6e25c) != 48) @compileError("__AnonStruct_86310e04a9e6e25c size mismatch");
        if (@alignOf(__AnonStruct_86310e04a9e6e25c) != 8) @compileError("__AnonStruct_86310e04a9e6e25c alignment mismatch");
    }
    if (@sizeOf(usize) == 4) {
        if (@sizeOf(__AnonStruct_86310e04a9e6e25c) != 32) @compileError("__AnonStruct_86310e04a9e6e25c size mismatch");
        if (@alignOf(__AnonStruct_86310e04a9e6e25c) != 8) @compileError("__AnonStruct_86310e04a9e6e25c alignment mismatch");
    }
}
...
pub const Update_for_hostResultPayload = extern union {
    err: i64,
    ok: __AnonStruct_cc47749ab4ee4e9a,
};
...
pub const Update_for_hostResult = if (@sizeOf(usize) == 4) extern struct {
    ...
    pub fn payload_ok(self: *const @This()) __AnonStruct_cc47749ab4ee4e9a {
        const ptr: *const __AnonStruct_cc47749ab4ee4e9a = @ptrCast(@alignCast(&self.payload));
        return ptr.*;
    }
    /// Recursively decrement Roc-owned payloads.
    pub fn decref(self: @This(), roc_host: *RocHost) void {
...
/// Roc signature: U64 => {}
/// Refcounted fields are owned by the hosted function.
pub const FileHostRelease_blobArgs = extern struct {
    arg0: u64,
};
...
pub const Update_for_hostArg1 = __AnonStruct_6b33d8d5fd6ed20e;
pub const Update_for_hostArg1Capture = __AnonStruct_725e46d8f9e562ab;
pub const Update_for_hostArg1Time = __AnonStruct_a7fabf5808088b4c;
...
pub const Update_for_hostOk = __AnonStruct_cc47749ab4ee4e9a;
pub const Update_for_hostOkTasks = __AnonStruct_86310e04a9e6e25c;
...
/// Roc signature: U64 => {}
pub extern fn roc_file_release_blob(arg0: u64) callconv(.c) void;
...
pub extern fn update_for_host(arg0: RocBox, arg1: __AnonStruct_6b33d8d5fd6ed20e) callconv(.c) Update_for_hostResult;
