...
pub const DbHeap = host_resource.HostResourceHeap(u64, DbResource, max_connections, 10, writeU64Token, readU64Token, destroyDb);
/// The statement heap's type. Its capacity is the statement bound.
pub const StmtHeap = host_resource.HostResourceHeap(u64, StmtResource, max_statements, 11, writeU64Token, readU64Token, destroyStmt);
